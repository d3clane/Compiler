#ifndef TOKENS_ARR_HASH_FUNCS_H
#define TOKENS_ARR_HASH_FUNCS_H
...
/// @return hash
HashType TokensArrMurmurHash(const void* hashingArr, const size_t length, const uint64_t seed = 0);
