...
// TODO: вообще плохое решение с тем чтобы хранить в общей NameTable инфу по backend
// потому что для разных backend выходит не оч приятная сиутация.
// Вообще говоря навскидку есть два решения
// Чтение дерева всегда одинаковое, потом каст к новой таблице имен и передавать ее
// Или в силу того что указания на локальные таблицы у меня void* я могу туда ваще пихать
// любые другие таблицы со своей логикой. 
// Еще вариант хранить в дереве строчки а потом создавать нужную таблицу имен в бекенд с нужными данными
