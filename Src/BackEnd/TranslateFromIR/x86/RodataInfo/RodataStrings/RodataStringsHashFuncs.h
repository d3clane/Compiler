#ifndef RODATA_STRINGS_HASH_FUNCS_H
#define RODATA_STRINGS_HASH_FUNCS_H
...
/// @return hash
HashType RodataStringsMurmurHash(const void* hashingArr, const size_t length, const uint64_t seed = 0);
